...
public class Tuple5<E1 extends Comparable<E1>, E2 extends Comparable<E2>, E3 extends Comparable<E3>, E4 extends Comparable<E4>, E5 extends Comparable<E5>> implements Comparable<Tuple5<E1, E2, E3, E4, E5>>, Serializable {
	...
	public int hashCode() {
		return 31 * (31 * (31 * (31 * (31 + (first == null ? 0 : first.hashCode())) + (second == null ? 0 : second.hashCode())) + third.hashCode()) + fourth.hashCode()) + fifth.hashCode();
	}
	
	public boolean equals(Object obj) {
		if (obj != null && this.getClass().equals(obj.getClass())) {
			Tuple5<E1, E2, E3, E4, E5> t = (Tuple5<E1, E2, E3, E4, E5>)obj;
			if (first.equals(t.getFirst()) && second.equals(t.getSecond()) && third.equals(t.getThird()) && fourth.equals(t.getFourth()) && fifth.equals(t.getFifth())) {
				return true;
			}
		}
		return false;
