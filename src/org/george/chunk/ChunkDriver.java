...
public class ChunkDriver {
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println(
				"sum test: " + (colp.sum(19, colp.length()).equals(colr.sum(19, colr.length())) ? "ok" : "not ok"));
		System.out.println("length test: "
				+ (colp.count(88, colp.length() - 1000).equals(colr.count(88, colr.length() - 1000)) ? "ok"
						: "not ok"));
		System.out.println("avg test: "
				+ (colp.avg(88, colp.length() - 1000).equals(colr.avg(88, colr.length() - 1000)) ? "ok" : "not ok"));
		System.out.println(colp.sum(88, colp.length() - 1000));
		System.out.println(colr.sum(88, colr.length() - 1000));
		System.out.println(colp.sum(88, colp.length() - 1000).equals(colr.sum(88, colr.length() - 1000)));
		...
		for (int k = 1000; k < 1000000 - 92323; k++) {
			 ...
			 * if (!colplain.sum(10, colplain.getLength() - 90000).equals(colbit.sum(10,
			 * colbit.getLength() - 90000))) { System.out.println("SUM NOT OK"); } if
			 * (!colplain.sum(10, colplain.getLength() - 90000).equals(colror.sum(10,
			 * colror.getLength() - 90000))) { System.out.println("1SUM NOT OK"); } if
			 * (!colplain.sum(10, colplain.getLength()).equals(colror.sum(10,
			 * colror.getLength()))) { System.out.println("2SUM NOT OK"); } if
			 * (!colplain.sum(10, colplain.getLength()).equals(colrle.sum(10,
			 * colrle.getLength()))) { System.out.println("2SUM NOT OK"); } if
			 * (!colplain.sum(10, colplain.getLength() - 90000).equals(colrle.sum(10,
			 * colrle.getLength() - 90000))) { System.out.println("2SUM NOT OK"); } if
			 * (!colplain.sum(0, colplain.getLength()).equals(colrle.sum(0,
			 * colrle.getLength()))) { System.out.println("2SUM NOT OK"); } if
			 * (!colplain.sum(0, colplain.getLength() - 90000).equals(colrle.sum(0,
			 * colrle.getLength() - 90000))) { System.out.println("2SUM NOT OK"); }
			 */
		...
		start = Instant.now();
		colplain.sum(0, colplain.length());
		end = Instant.now();
		duration = Duration.between(start, end);
		...
		start = Instant.now();
		colrle.sum(0, colrle.length());
		end = Instant.now();
		duration = Duration.between(start, end);
		System.out.println("RLE: " + duration.toMillis() + " ms");
		System.out.println(colrle.sum(0, colrle.length()));

		start = Instant.now();
		colbit.sum(0, colbit.length());
		end = Instant.now();
		duration = Duration.between(start, end);
		System.out.println("BITSET: " + duration.toMillis() + " ms");
		System.out.println(colbit.sum(0, colbit.length()));

		start = Instant.now();
		colror.sum(0, colror.length());
		end = Instant.now();
		duration = Duration.between(start, end);
		System.out.println("ROARING: " + duration.toMillis() + " ms");
		System.out.println(colror.sum(0, colror.length()));
